...
25. The hack photos appear as expected on all devices and the embedded videos play and work as expected on all devices. On the larger screens where the size of the video matches the size of the hack text box for symmetry purposes it is expected that black lines will appear above and below the videos so that they maintain the correct aspect ratio.
26. On the tablet device, the page appears as expected in both portrait and landscape view on all browsers. In portrait view the photos and videos are the same width as the hack text boxes and in landscape view the photos and videos are half the size of the hack text boxes. As the size of the videos is not dictated by any adjacent text box on smaller screens, the aspect ratio of the videos is able to adjust so that there are no black lines around the videos when they are playing giving the videos a clean borderless appearance.
27. On the mobile devices tested, the page appears as expected in both portrait and landscape view with the hack photos and videos being the same width as the hack text boxes. 
